...
import { deleteController, getAllController, getController, getCurrentController, postController, putController } from "../../controller/product.controller.js"

export const router= Router()

router.get('/',authenticateWithJwt,getAllController)
router.get('/_id',authenticateWithJwt,getController)
router.get('/current',authenticateWithJwt,getCurrentController)
